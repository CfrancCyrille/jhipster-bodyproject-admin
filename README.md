...
To build the final jar and optimize the jhBodyProjectAdmin application for production, run:
...
Then navigate to [http://localhost:5001](http://localhost:5001) in your browser.
